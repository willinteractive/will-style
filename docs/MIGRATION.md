...
| P3 | Replace `gulp-sharp-responsive` (private git fork) with an actively maintained responsive-image tool. Not urgent — current fork works and everyone has SSH access — but do it before it becomes someone's onboarding blocker. | — | Medium |
