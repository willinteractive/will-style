...
module WILL
  ...
  module Style
    ...
    module Foundation
      ...
      ##
      # Helpers for generating Foundation form elements
      #
      module FormHelper
        class FormBuilder < ActionView::Helpers::FormBuilder
          ...
          # @FIXME: Probably shouldn't bs this...
          def error_message(message="This form has errors.")
            if object.respond_to?(:errors) && object.errors.any?
              "<div class=\"alert-box alert\" data-alert>#{message.html_safe}</div>".html_safe
            end
          end
        ...
        private
          ...
          def error_and_hint(attribute, options = {})
            ...
            html += error_for(attribute, options) || "" unless options[:ignore_errors] == true
            html.html_safe
          end
