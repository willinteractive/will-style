...
import { on } from "will_style/core/events";
...
on("update-animated-elements", function() {
  _scheduleAnimatedElementsUpdate();
});

on("reset-animated-elements", function() {
  _resetAnimationCache();
  _scheduleAnimatedElementsUpdate();
});

on("css-initialized", function() {
...
on("image-loaded", function(image) {
...
if (Settings.synchronousCSS === false) {
